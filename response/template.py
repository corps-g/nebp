...
190 13 -0.001205  (101 -199 124 -111  115):
                  (101 -199 125 -115  117):
                  (101 -199 126 -117  119):
                  (101 -199 -119):
...
c
111 1 PZ    0.9             $ plane tip top
112 1 PZ    0.7             $ plane tip bot
113 1 PZ    0.2             $ plane crystal top
114 1 PZ   -0.2             $ plane crystal bot
115 1 PZ   -3.6             $ plane 1.5
116 1 PZ   -3.8             $ plane 1.6
117 1 PZ   -9.6             $ plane 1.7
118 1 PZ  -10.8             $ plane 1.8
119 1 PZ  -19.1             $ plane 1.9
c
121 1 CZ    0.20            $ cylinder 1.1
122 1 CZ    0.50            $ cylinder 1.2
123 1 CZ    0.60            $ cylinder 1.3
124 1 CZ    0.70            $ cylinder 1.4
125 1 CZ    0.90            $ cylinder 1.5
126 1 CZ    2.54            $ cylinder 1.6
127 1 CZ    2.14            $ cylinder 1.7
c
c
199 1 SO   80.0             $ graveyard
c
c
c                          -----Foil Tube------
...
point_bonner_template = '''Bonner Sphere Template
c
c ******************************************************************************
c                               CELL CARDS
c ******************************************************************************
...
111 2  -0.95    (-101 -111):
                (-101  111 -115 124):
                (-101  115 -117 125):
                (-101  117 126)              IMP:N=1        $ HDPE Sphere
121 11 -3.84     -121  113 -114              IMP:N=1        $ Detector Assembly
122 0           ( 112 -113 -122):
                ( 113 -114 121 -122)         IMP:N=1        $ Vacuum Around Crystal
123 12 -2.50    (-122  114 -116):
                (-123  116 -118)             IMP:N=1        $ PMMA Light Guide
124  1 -2.699   (-124  111 -112):
                (-124  122  112 -115):
                (-125  115 -116 122):
                (-125  116 -117 123):
                (-126  117 -118 123):
                (-126  118 -119 127)         IMP:N=1        $ Aluminum Casing
125 0            -127  118 -119              IMP:N=1        $ PMT Vacuum
190 0           (101 -199 124  111 -115):
                (101 -199 125  115 -117):
                (101 -199 126  117 -119):
                (101 -199  119):
                (101 -199 -111)              IMP:N=1        $ Air Around Sphere
199 0                 199                    IMP:N=0        $ Graveyard
c
